...
function Radiobutton({ label, name, value, checked }: {label: string, name: string, value: string, checked: boolean}) {
  return (
    <div className="ml-5 inline-block -ml-1 my-2">
      <label className="flex flex-row text-sm items-center justify-center cursor-pointer select-none">
        <input className="hide-radio" type="radio" value={value} name={name} readOnly checked={checked} />
